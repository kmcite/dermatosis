...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      ...
      name: 'Address',
      lastPropertyId: const obx_int.IdUid(5, 9045478344759115485),
      flags: 0,
  ...
  obx_int.ModelEntity(
      ...
      name: 'Contact',
      lastPropertyId: const obx_int.IdUid(4, 3895837602319741424),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
  ...
  obx_int.ModelEntity(
      ...
      name: 'Imagery',
      lastPropertyId: const obx_int.IdUid(2, 2963530678687840041),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
  ...
  obx_int.ModelEntity(
      ...
      name: 'Lesion',
      lastPropertyId: const obx_int.IdUid(2, 2809150687386814021),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
  ...
  obx_int.ModelEntity(
      ...
      name: 'Patient',
      lastPropertyId: const obx_int.IdUid(13, 4304149839896931907),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
        ...
        obx_int.ModelProperty(
            ...
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(12, 3067600840751836998),
            name: 'modifiedOn',
            type: 10,
            flags: 0),
        obx_int.ModelProperty(
      ...
      relations: <obx_int.ModelRelation>[
        obx_int.ModelRelation(
            id: const obx_int.IdUid(1, 4372088283872831827),
            name: 'lesions',
            targetId: const obx_int.IdUid(4, 7031229979224591978)),
        obx_int.ModelRelation(
  ...
  obx_int.ModelEntity(
      ...
      name: 'Doctor',
      lastPropertyId: const obx_int.IdUid(4, 2149571582222653003),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      ...
      lastIndexId: const obx_int.IdUid(2, 4464186779726439750),
      lastRelationId: const obx_int.IdUid(2, 5078272849828177414),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    ...
    Patient: obx_int.EntityDefinition<Patient>(
        ...
        objectToFB: (Patient object, fb.Builder fbb) {
          ...
          fbb.addInt64(11, object.modifiedOn.millisecondsSinceEpoch);
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final object = Patient()
            ...
            ..complaints = const fb.StringReader(asciiOptimization: true)
                .vTableGet(buffer, rootOffset, 20, '')
            ..management = const fb.StringReader(asciiOptimization: true)
                .vTableGet(buffer, rootOffset, 22, '')
            ..presentation = DateTime.fromMillisecondsSinceEpoch(
...
class Patient_ {
  ...
  static final complaints =
      obx.QueryStringProperty<Patient>(_entities[4].properties[8]);

  /// See [Patient.management].
  static final management =
      obx.QueryStringProperty<Patient>(_entities[4].properties[9]);

  /// See [Patient.presentation].
  static final presentation =
      obx.QueryDateProperty<Patient>(_entities[4].properties[10]);

  /// See [Patient.modifiedOn].
  static final modifiedOn =
      obx.QueryDateProperty<Patient>(_entities[4].properties[11]);

  /// See [Patient.email].
  static final email =
      obx.QueryStringProperty<Patient>(_entities[4].properties[12]);
...
class Doctor_ {
  /// See [Doctor.id].
  static final id =
      obx.QueryIntegerProperty<Doctor>(_entities[5].properties[0]);

  /// See [Doctor.name].
  static final name =
      obx.QueryStringProperty<Doctor>(_entities[5].properties[1]);

  /// See [Doctor.description].
  static final description =
      obx.QueryStringProperty<Doctor>(_entities[5].properties[2]);

  /// See [Doctor.email].
  static final email =
      obx.QueryStringProperty<Doctor>(_entities[5].properties[3]);
}
